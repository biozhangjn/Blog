...
### 安装scoop用以管理Windows软件

等着吃午饭是最幸福的(丈母娘来了)，不干活了就打开折腾下新安装的3700X电脑，装了两个月，都没有时间用，VScode倒是早就装好了，可以当个记事本用（就是这么全能），blog在OneDrive里面，直接打开文件夹就同步，尴尬的发现没有git，刚好上次更新blog的时候发现了scoop在windows里面炒鸡好用，所以感觉再熟悉一遍，流水账来啦：
